...
lblAge.grid(row=1, column=4, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("Calibri", 16), width=30)
txtAge.grid(row=1, column=6, padx=10, pady=10, sticky="w")
...
lblEmail.grid(row=2, column=4, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("Calibri", 16), width=30)
txtEmail.grid(row=2, column=6, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Gender", font=("Calibri", 16), bg="black", fg="white")
lblGender.grid(row=3, column=2, padx=10, pady=10, sticky="w")
...
lblContact.grid(row=3, column=4, padx=10, pady=10, sticky="w")
txtContact = Entry(entries_frame, textvariable=contact, font=("Calibri", 16), width=30)
txtContact.grid(row=3, column=6, padx=10, sticky="w")
...
txtAddress.grid(row=5, column=3, columnspan=4, padx=10, sticky="w")
...
def team():
    messagebox.showinfo("Team members", "Rishap,Sunjay,Renikshan,Ramana")
...
btn_frame.grid(row=6, column=3, columnspan=4, padx=10, pady=10, sticky="w")
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=15, font=("Calibri", 16, "bold"), fg="white",
                bg="#16a085", bd=0).grid(row=0, column=2)
...
btnteam = Button(btn_frame, command=team, text="Team Members", width=15, font=("Calibri", 16, "bold"), fg="white",
                  bg="gold",
                  bd=0).grid(row=0, column=7, padx=10)                  
